pipeline {
    ...
    environment {
        ...
        LOG_FILE = 'logs/log.txt'
        PPK_PATH = 'C:\\Users\\chame\\.ssh\\id_ed25519_digitalocean.ppk'
    ...
    stages {
        ...
        stage('Scraping') {
            steps {
                ...
                // Tu peux ajouter un check ici si tu veux logger ou vérifier la sortie de scraper.py
            }
        }
        ...
        stage('Deploy') {
            steps {
                ...
                bat '''
                    ...
                    if exist "%PPK_PATH%" (echo OK: clé trouvée )  else (echo ERREUR: clé SSH introuvable! & exit /b 1)
...
ame\\.ssh\\id_ed25519_digitalocean.ppk'
